...
public class ControllerImpl implements Controller {
	...
	public String addAstronaut(String type, String astronautName) {
		...
		case "Meteorologist":
			...
			break;
		default:
			throw new IllegalArgumentException(String.format(ExceptionMessages.ASTRONAUT_DOES_NOT_EXIST,"type"));
		}
	...
	public String report() {
		...
		builder.append(String.format(ConstantMessages.REPORT_PLANET_EXPLORED, countExploredPlanets))
		...
		this.astronautRepository.getModels().forEach(a -> {
			builder.append(String.format(ConstantMessages.REPORT_ASTRONAUT_NAME, a.getName()))
					.append(System.lineSeparator());
			builder.append(String.format(ConstantMessages.REPORT_ASTRONAUT_OXYGEN, a.getOxygen()))
					.append(System.lineSeparator());
